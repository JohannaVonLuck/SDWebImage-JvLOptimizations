...
typedef void(^SDWebImageImageDataCompletionBlock)(NSData *data);
 ...
 */
- (NSOperation *)queryCacheForKey:(NSString *)key options:(SDWebImageScaledOptions)options done:(SDWebImageQueryCompletedBlock)doneBlock;
